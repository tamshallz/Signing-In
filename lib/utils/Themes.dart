...
class AppTheme {
  ...
  static final TextStyle _titleLight = TextStyle(
    color: Colors.black,
    fontSize: 3.5 * ResponsiveSizeConfig.textMultiplier,
  );

  static final TextStyle _subTitleLight = TextStyle(
    color: subTitleTextColor,
    fontSize: 2 * ResponsiveSizeConfig.textMultiplier,
    height: 1.5,
  );

  static final TextStyle _buttonLight = TextStyle(
    color: Colors.black,
    fontSize: 2.5 * ResponsiveSizeConfig.textMultiplier,
  );

  static final TextStyle _greetingLight = TextStyle(
    color: Colors.black,
    fontSize: 2.0 * ResponsiveSizeConfig.textMultiplier,
  );

  static final TextStyle _searchLight = TextStyle(
    color: Colors.black,
    fontSize: 2.3 * ResponsiveSizeConfig.textMultiplier,
  );
